...
export default defineConfig({
  shortcuts: {
    ...
    input: 'block w-full rounded border-0 px-4 py-2 text-sm text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-gray-500'
  },
  presets: [
    presetAttributify(),
    presetUno(),
