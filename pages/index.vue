      ...
      <div class="pb-80 pt-16 sm:pb-40 sm:pt-24 lg:pb-48 lg:pt-40">
        <div class="relative mx-auto max-w-7xl sm:static sm:px-6 lg:px-8">
          <div class="sm:max-w-lg">
            <h1 class="text-4xl font-semibold tracking-tight text-gray-900 sm:text-6xl">Summer styles are finally here</h1>
          ...
          <div>
            <div class="mt-10">
              ...
              <nuxt-link to="/products" class="inline-block rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-center font-medium text-white hover:bg-indigo-700">Shop Collection</nuxt-link>
            </div>
          </div>
        </div>
      </div>
